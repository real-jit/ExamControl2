...
\restrict LqCKmnj4Vg0b8aacm5M2Ta8aklaI4wo31qrzFESsnvBjaL1XtJYxvdLqDtCe3YH

-- Dumped from database version 18.4
-- Dumped by pg_dump version 18.3

-- Started on 2026-05-25 19:10:53
...
COPY public.order_products (order_products_id, order_id, product_id, quantity) FROM stdin;
1	1	1	2
2	2	3	1
3	3	5	10
4	4	7	5
...
COPY public.orders (order_id, order_date, issue_date, pickup_point_id, order_fio, receive_code, status_id) FROM stdin;
...
7	2025-02-27	2025-04-26	3	Сазонов Руслан Германович	907	1
...
COPY public.products (product_id, article, product_name, unit, price, category_id, manufacturer_id, supplier_id, discount, quantity, description, image_path) FROM stdin;
1	А112Т4	Ботинки	шт.	4990.00	1	1	1	3	6	Женские Ботинки демисезонные kari	images/1.jpg
2	F635R4	Ботинки	шт.	3244.00	1	2	2	2	13	Ботинки Marco Tozzi женские демисезонные, размер 39, цвет бежевый	images/2.jpg
3	H782T5	Туфли	шт.	4499.00	2	1	1	4	5	Туфли kari мужские классика MYZ21AW-450A, размер 43, цвет: черный	images/3.jpg
4	G783F5	Ботинки	шт.	5900.00	2	3	1	2	8	Мужские ботинки Рос-Обувь кожаные с натуральным мехом	images/4.jpg
...
8	D329H3	Полуботинки	шт.	1890.00	1	5	2	4	4	Полуботинки Alessio Nesca женские 3-30797-47, размер 37, цвет: бордовый	images/8.jpg
...
15	O754F4	Туфли	шт.	5400.00	1	4	2	4	18	Туфли женские демисезонные Rieker артикул 55073-68/37	\N
16	G531F4	Ботинки	шт.	6600.00	1	1	1	12	9	Ботинки женские зимние ROMER арт. 893167-01 Черный	\N
17	J542F5	Тапочки	шт.	500.00	2	1	1	13	0	Тапочки мужские Арт.70701-55-67син р.41	\N
...
21	F427R5	Ботинки	шт.	11800.00	1	4	2	15	11	Ботинки на молнии с декоративной пряжкой FRAU	\N
...
27	D268G5	Туфли	шт.	4399.00	1	4	2	3	12	Туфли Rieker женские демисезонные, размер 36, цвет коричневый	\N
28	T324F5	Сапоги	шт.	4699.00	1	6	1	2	5	Сапоги замша Цвет: синий	\N
29	K358H6	Тапочки	шт.	599.00	2	4	1	20	2	Тапочки мужские син р.41	\N
30	H535R5	Ботинки	шт.	2300.00	1	4	2	2	7	Женские Ботинки демисезонные	\N
\.
...
-- Completed on 2026-05-25 19:10:53

--
-- PostgreSQL database dump complete
--

\unrestrict LqCKmnj4Vg0b8aacm5M2Ta8aklaI4wo31qrzFESsnvBjaL1XtJYxvdLqDtCe3YH
